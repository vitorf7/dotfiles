{ self, ... }:
{
  flake.modules.homeManager.tide-island = { config, pkgs, lib, osConfig, ... }: lib.mkIf osConfig.vitorf7.desktop.tide_island.enable {
    assertions = [
      {
    ...
    xdg.configFile."hypr-tide-island/keybinds.lua".source =
